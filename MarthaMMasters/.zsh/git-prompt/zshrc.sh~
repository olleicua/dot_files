...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$bg[black]%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%F{magenta}%{$bg[black]%} │%f"
ZSH_THEME_GIT_PROMPT_SEPARATOR="%{$bg[black]%}"
ZSH_THEME_GIT_PROMPT_BRANCH="%{$fg_bold[cyan]%}"
ZSH_THEME_GIT_PROMPT_STAGED="%{$fg[green]%}%{$bg[black]%}%B╺"
ZSH_THEME_GIT_PROMPT_CONFLICTS="%{$fg[red]%}%{$bg[black]%}%B✗"
ZSH_THEME_GIT_PROMPT_CHANGED="%{$fg[magenta]%}%{$bg[black]%}%B┅"
ZSH_THEME_GIT_PROMPT_REMOTE="%{$fg[yellow]%}%{$bg[black]%}%B"
ZSH_THEME_GIT_PROMPT_UNTRACKED="%{$fg[red]%}%{$bg[black]%}%B┅"
ZSH_THEME_GIT_PROMPT_CLEAN="%{$fg_bold[green]%}%{$bg[black]%}%B✔"
